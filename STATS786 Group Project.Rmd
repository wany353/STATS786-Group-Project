...
```{r}
fc = arima_fit %>% select(auto) %>% forecast(h=8)
hilo(fc, 95)

accuracy(fc, full)[c(".model", "MAE", "RMSE", "MAPE", "MASE")]
```
...
For the ARIMA model which we believe has the best predictive ability, the MAE is
155, the RMSE is 172, the MAPE us 4.19 and the MASE is 1.32.
